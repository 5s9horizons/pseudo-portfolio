      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-invert prose-lg max-w-none text-gray-300 bg-gray-800/30 p-6 md:p-8 rounded-lg shadow-lg">
          ...
          <h2>4. AI Chatbot</h2>
            ...
            <p>
                Your use of the AI Chatbot is subject to the terms and privacy policies of Google (for the Gemini API). We are not responsible for data handling practices by Google.
            </p>
            <p>
